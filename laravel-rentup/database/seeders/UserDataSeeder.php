...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        // Seed Bookings with valid 'payment_status' values
        Booking::create([
            'user_id' => $user1->id,
            'listing_id' => $listing1->id,
            'status' => 'confirmed',
            'payment_method' => 'paypal',
            'payment_status' => 'paid', // Make sure this is a valid value
            'is_deleted' => false,
        ...
        Booking::create([
            ...
            'status' => 'pending',
            'payment_method' => 'cash',
            'payment_status' => 'pending', // Make sure this is a valid value
            'is_deleted' => false,
